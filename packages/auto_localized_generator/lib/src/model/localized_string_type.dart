abstract class LocalizedStringType {
  ...
  const LocalizedStringType(this.id, this.name);
...
class PlainLocalizedStringType extends LocalizedStringType {
  const PlainLocalizedStringType() : super(0, 'PlainLocalizedString');
}

class ArgLocalizedStringType1 extends LocalizedStringType {
  const ArgLocalizedStringType1() : super(1, 'ArgLocalizedString1');
}

class ArgLocalizedStringType2 extends LocalizedStringType {
  const ArgLocalizedStringType2() : super(2, 'ArgLocalizedString2');
}

class ArgLocalizedStringType3 extends LocalizedStringType {
  const ArgLocalizedStringType3() : super(3, 'ArgLocalizedString3');
}

class ArgLocalizedStringType4 extends LocalizedStringType {
  const ArgLocalizedStringType4() : super(4, 'ArgLocalizedString4');
}

class ArgLocalizedStringType5 extends LocalizedStringType {
  const ArgLocalizedStringType5() : super(5, 'ArgLocalizedString5');
}
