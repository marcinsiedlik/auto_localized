...
class AutoLocalizedGenerator extends GeneratorForAnnotation<AutoLocalized> {
  @override
  Future generateForAnnotatedElement(Element element, ConstantReader annotation, BuildStep buildStep) async {
    final config = await AnnotationConfigResolver(element, annotation, buildStep).resolve();
